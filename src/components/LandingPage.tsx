...
export function LandingPage() {
    ...
    // Prevent rendering until auth is fully loaded.
    // Also, if user is already signed in (userId exists), we shouldn't render this page 
    // to avoid the "cannot_render_single_session_enabled" warning.
    if (!isLoaded || userId) {
        return null; // Or a loading spinner if preferred, but null is cleaner for flashes
    }
